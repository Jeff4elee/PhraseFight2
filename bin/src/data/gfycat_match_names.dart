...
class GfycatMatchNames {
  static String getRandomMatchId() {
    ...
    String ad2 = _adjectives[random.nextInt(_adjectives.length)];
    String animal = _animals[random.nextInt(_animals.length)];
    return "$ad1-$ad2-$animal";
  }

  static final List _animals = '''aardvark
aardwolf
abalone
abyssiniancat
